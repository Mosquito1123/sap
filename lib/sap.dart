...
import 'package:sap/interruption/interruption_resolver.dart';
...
///
/// Do not instantiate this class. Instead use [Sap.instance] initializer to make
...
class Sap with DataMixin {
  static const MethodChannel _channel =
  const MethodChannel('sap');

  /// Singleton shared instance of the Gigya SDK.
  static final Sap instance = Sap._();
